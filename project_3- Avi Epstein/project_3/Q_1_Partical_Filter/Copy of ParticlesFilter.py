...
class ParticlesFilter:
    ...
    def Observation(self):
      ...
      for i in range(self.numberOfParticles):
        ditance_x_y = np.subtract(self.worldLandmarks , [self.particles[i][0],self.particles[i][1]])
        ...
        r_partical = np.sqrt(np.power(closeset_landmark[0] - self.particles[i][0],2) + np.power(closeset_landmark[1] - self.particles[i][1],2)) #possibly add noise ask roy
        phi_partical = np.arctan2(closeset_landmark[1] - self.particles[i][1],closeset_landmark[0] - self.particles[i][0]) #possibly add noise ask roy
    ...
    def resampleParticles(self):
      ...
      for i in range(self.numberOfParticles):
        ...
        #print ("i", i, "w ", self.particles[i][3])
        self.particles[i][3] = w/self.total_weight
        sum1 +=self.particles[i][3]
        #print ("i", i, "w normlized", self.particles[i][3])
      #print("sum1:", sum1)
